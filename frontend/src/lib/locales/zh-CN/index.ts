...
export const zhCN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "无法访问 eeroNotebook API 服务器",
    dbTitle: "数据库连接失败",
  ...
  notebooks: {
    ...
    share: "共享",
    shareNotebook: "共享笔记本",
    shareNotebookDesc: "授予某一位成员对“{{name}}”的只读访问权限。对方可以阅读来源并提问，但不能修改任何内容。",
    shareEmailLabel: "电子邮件地址",
    shareEmailPlaceholder: "person@example.com",
    shareGrant: "授予访问权限",
    shareOnePersonHint: "每次只能授予一位成员。无法把笔记本共享给所有人。",
    shareLoading: "正在加载有访问权限的成员...",
    shareNobodyYet: "目前没有其他成员可以访问此笔记本。",
    shareRoleViewer: "查看者",
    shareGrantedAgo: "授予时间：{{time}}",
    shareUnnamedMember: "没有电子邮件地址的成员",
    shareRevoke: "撤销访问权限",
    shareRevokeConfirm: "要结束 {{name}} 对此笔记本的访问权限吗？访问会立即停止，笔记本中的内容不会被删除。",
    shareGrantSuccess: "已授予访问权限",
    shareGrantFailed: "无法共享此笔记本",
    shareRevokeSuccess: "已撤销访问权限",
    shareRevokeFailed: "无法撤销访问权限",
    sharedWithYou: "已共享给你",
    viewerReadOnlyNotice: "你对此笔记本拥有只读访问权限，可以阅读其来源并提问。",
    noNotesViewer: "此笔记本的所有者尚未添加任何笔记。",
  },
  sources: {
    bulkContext: "上下文",
    ...
    noSourcesViewer: "此笔记本的所有者尚未添加任何来源。",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 eeroNotebook 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{{models}}。如果没有这些模型，eeroNotebook 可能无法正常运行。",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 eeroNotebook 中启用 AI 服务商。",
