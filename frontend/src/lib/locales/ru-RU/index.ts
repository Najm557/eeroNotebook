...
export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер eeroNotebook недоступен",
  ...
  notebooks: {
    ...
    share: "Поделиться",
    shareNotebook: "Поделиться блокнотом",
    shareNotebookDesc: "Предоставьте одному человеку доступ только для чтения к \"{{name}}\". Он сможет читать источники и задавать вопросы, но ничего не изменит.",
    shareEmailLabel: "Адрес электронной почты",
    shareEmailPlaceholder: "person@example.com",
    shareGrant: "Предоставить доступ",
    shareOnePersonHint: "По одному человеку за раз. Поделиться блокнотом со всеми невозможно.",
    shareLoading: "Загрузка тех, у кого есть доступ...",
    shareNobodyYet: "Ни у кого больше нет доступа к этому блокноту.",
    shareRoleViewer: "Читатель",
    shareGrantedAgo: "Доступ предоставлен {{time}}",
    shareUnnamedMember: "Участник без адреса электронной почты",
    shareRevoke: "Отозвать доступ",
    shareRevokeConfirm: "Прекратить доступ {{name}} к этому блокноту? Доступ прекратится немедленно. Содержимое блокнота не удаляется.",
    shareGrantSuccess: "Доступ предоставлен",
    shareGrantFailed: "Не удалось поделиться блокнотом",
    shareRevokeSuccess: "Доступ отозван",
    shareRevokeFailed: "Не удалось отозвать доступ",
    sharedWithYou: "Доступ предоставлен вам",
    viewerReadOnlyNotice: "У вас доступ только для чтения к этому блокноту. Вы можете читать его источники и задавать вопросы.",
    noNotesViewer: "Владелец этого блокнота ещё не добавил заметок.",
  },
  sources: {
    ...
    noSourcesViewer: "Владелец этого блокнота ещё не добавил источников.",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить eeroNotebook автоматически удалять загруженные файлы из папки загрузок.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в eeroNotebook",
    missingRequiredModels: "Отсутствуют необходимые модели: {{models}}. eeroNotebook может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в eeroNotebook.",
