...
export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de eeroNotebook est injoignable",
  ...
  notebooks: {
    ...
    share: "Partager",
    shareNotebook: "Partager le carnet",
    shareNotebookDesc: "Donnez à une personne un accès en lecture seule à \"{{name}}\". Elle pourra lire les sources et poser des questions, sans rien modifier.",
    shareEmailLabel: "Adresse e-mail",
    shareEmailPlaceholder: "personne@exemple.com",
    shareGrant: "Accorder l'accès",
    shareOnePersonHint: "Une personne à la fois. Il n'existe aucun moyen de partager un carnet avec tout le monde.",
    shareLoading: "Chargement des personnes ayant accès...",
    shareNobodyYet: "Personne d'autre n'a accès à ce carnet.",
    shareRoleViewer: "Lecteur",
    shareGrantedAgo: "Accès accordé {{time}}",
    shareUnnamedMember: "Membre sans adresse e-mail",
    shareRevoke: "Révoquer l'accès",
    shareRevokeConfirm: "Mettre fin à l'accès de {{name}} à ce carnet ? L'accès cesse immédiatement. Rien n'est supprimé dans le carnet.",
    shareGrantSuccess: "Accès accordé",
    shareGrantFailed: "Impossible de partager le carnet",
    shareRevokeSuccess: "Accès révoqué",
    shareRevokeFailed: "Impossible de révoquer l'accès",
    sharedWithYou: "Partagé avec vous",
    viewerReadOnlyNotice: "Vous avez un accès en lecture seule à ce carnet. Vous pouvez lire ses sources et poser des questions.",
    noNotesViewer: "Le propriétaire de ce carnet n'a encore ajouté aucune note.",
  },
  sources: {
    ...
    noSourcesViewer: "Le propriétaire de ce carnet n'a encore ajouté aucune source.",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser eeroNotebook à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'eeroNotebook",
    missingRequiredModels: "Modèles requis manquants : {{models}}. eeroNotebook pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans eeroNotebook.",
