...
export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 eeroNotebook API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  notebooks: {
    ...
    share: "共用",
    shareNotebook: "共用筆記本",
    shareNotebookDesc: "授予某一位成員對「{{name}}」的唯讀存取權。對方可以閱讀來源並提問，但不能變更任何內容。",
    shareEmailLabel: "電子郵件地址",
    shareEmailPlaceholder: "person@example.com",
    shareGrant: "授予存取權",
    shareOnePersonHint: "每次只能授予一位成員。無法將筆記本共用給所有人。",
    shareLoading: "正在載入具有存取權的成員...",
    shareNobodyYet: "目前沒有其他成員可以存取此筆記本。",
    shareRoleViewer: "檢視者",
    shareGrantedAgo: "授予時間：{{time}}",
    shareUnnamedMember: "沒有電子郵件地址的成員",
    shareRevoke: "撤銷存取權",
    shareRevokeConfirm: "要結束 {{name}} 對此筆記本的存取權嗎？存取會立即停止，筆記本中的內容不會被刪除。",
    shareGrantSuccess: "已授予存取權",
    shareGrantFailed: "無法共用此筆記本",
    shareRevokeSuccess: "已撤銷存取權",
    shareRevokeFailed: "無法撤銷存取權",
    sharedWithYou: "已共用給你",
    viewerReadOnlyNotice: "你對此筆記本擁有唯讀存取權，可以閱讀其來源並提問。",
    noNotesViewer: "此筆記本的擁有者尚未新增任何筆記。",
  },
  sources: {
    bulkContext: "上下文",
    ...
    noSourcesViewer: "此筆記本的擁有者尚未新增任何來源。",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 eeroNotebook 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{{models}}。如果没有這些模型，eeroNotebook 可能無法正常運行。",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 eeroNotebook 中啟用 AI 服務商。",
