...
export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do eeroNotebook não pôde ser alcançado",
  ...
  notebooks: {
    ...
    share: "Compartilhar",
    shareNotebook: "Compartilhar caderno",
    shareNotebookDesc: "Dê a uma pessoa acesso somente leitura a \"{{name}}\". Ela pode ler as fontes e fazer perguntas, mas não pode alterar nada.",
    shareEmailLabel: "Endereço de e-mail",
    shareEmailPlaceholder: "pessoa@exemplo.com",
    shareGrant: "Conceder acesso",
    shareOnePersonHint: "Uma pessoa por vez. Não há como compartilhar um caderno com todos.",
    shareLoading: "Carregando quem tem acesso...",
    shareNobodyYet: "Mais ninguém tem acesso a este caderno.",
    shareRoleViewer: "Visualizador",
    shareGrantedAgo: "Acesso concedido {{time}}",
    shareUnnamedMember: "Membro sem endereço de e-mail",
    shareRevoke: "Revogar acesso",
    shareRevokeConfirm: "Encerrar o acesso de {{name}} a este caderno? O acesso para imediatamente. Nada no caderno é excluído.",
    shareGrantSuccess: "Acesso concedido",
    shareGrantFailed: "Não foi possível compartilhar o caderno",
    shareRevokeSuccess: "Acesso revogado",
    shareRevokeFailed: "Não foi possível revogar o acesso",
    sharedWithYou: "Compartilhado com você",
    viewerReadOnlyNotice: "Você tem acesso somente leitura a este caderno. Pode ler as fontes e fazer perguntas.",
    noNotesViewer: "O proprietário deste caderno ainda não adicionou notas.",
  },
  sources: {
    ...
    noSourcesViewer: "O proprietário deste caderno ainda não adicionou fontes.",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o eeroNotebook exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no eeroNotebook",
    missingRequiredModels: "Modelos obrigatórios ausentes: {{models}}. O eeroNotebook pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no eeroNotebook.",
