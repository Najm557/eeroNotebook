export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The eeroNotebook API server could not be reached",
  ...
  notebooks: {
    ...
    shareNotebookDesc: "Give one person read-only access to \"{{name}}\". They can read its sources and ask questions; they cannot change anything.",
    shareEmailLabel: "Email address",
    shareEmailPlaceholder: "person@example.com",
    shareGrant: "Grant access",
    shareOnePersonHint: "One person at a time. There is no way to share a notebook with everyone.",
    shareLoading: "Loading who has access...",
    shareNobodyYet: "Nobody else has access to this notebook.",
    shareRoleViewer: "Viewer",
    shareGrantedAgo: "Access granted {{time}}",
    shareUnnamedMember: "Member with no email address",
    shareRevoke: "Revoke access",
    shareRevokeConfirm: "End {{name}}'s access to this notebook? Their access stops immediately. Nothing in the notebook is deleted.",
    shareGrantSuccess: "Access granted",
    shareGrantFailed: "Could not share the notebook",
    shareRevokeSuccess: "Access revoked",
    shareRevokeFailed: "Could not revoke access",
    sharedWithYou: "Shared with you",
    viewerReadOnlyNotice: "You have read-only access to this notebook. You can read its sources and ask questions.",
    noNotesViewer: "The owner of this notebook has not added any notes.",
  },
  sources: {
    title: "Sources",
    bulkContext: "Context",
    ...
    noSourcesViewer: "The owner of this notebook has not added any sources yet.",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow eeroNotebook to delete uploaded files from the upload folder automatically.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across eeroNotebook",
    missingRequiredModels: "Missing required models: {{models}}. eeroNotebook may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in eeroNotebook.",
