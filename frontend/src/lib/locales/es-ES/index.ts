...
export const esES = {
  ...
  connectionErrors: {
    ...
    apiDesc: "No se pudo alcanzar el servidor API de eeroNotebook",
  ...
  notebooks: {
    ...
    share: "Compartir",
    shareNotebook: "Compartir cuaderno",
    shareNotebookDesc: "Da a una persona acceso de solo lectura a \"{{name}}\". Podrá leer sus fuentes y hacer preguntas, pero no cambiar nada.",
    shareEmailLabel: "Dirección de correo electrónico",
    shareEmailPlaceholder: "persona@ejemplo.com",
    shareGrant: "Conceder acceso",
    shareOnePersonHint: "Una persona a la vez. No hay forma de compartir un cuaderno con todo el mundo.",
    shareLoading: "Cargando quién tiene acceso...",
    shareNobodyYet: "Nadie más tiene acceso a este cuaderno.",
    shareRoleViewer: "Lector",
    shareGrantedAgo: "Acceso concedido {{time}}",
    shareUnnamedMember: "Miembro sin dirección de correo electrónico",
    shareRevoke: "Revocar acceso",
    shareRevokeConfirm: "¿Terminar el acceso de {{name}} a este cuaderno? El acceso se detiene de inmediato. No se elimina nada del cuaderno.",
    shareGrantSuccess: "Acceso concedido",
    shareGrantFailed: "No se pudo compartir el cuaderno",
    shareRevokeSuccess: "Acceso revocado",
    shareRevokeFailed: "No se pudo revocar el acceso",
    sharedWithYou: "Compartido contigo",
    viewerReadOnlyNotice: "Tienes acceso de solo lectura a este cuaderno. Puedes leer sus fuentes y hacer preguntas.",
    noNotesViewer: "El propietario de este cuaderno aún no ha añadido notas.",
  },
  sources: {
    ...
    noSourcesViewer: "El propietario de este cuaderno aún no ha añadido fuentes.",
  ...
  settings: {
    ...
    filesHelp: "Una vez que tus archivos se suben y procesan, ya no son necesarios. La mayoría de los usuarios deberían permitir que eeroNotebook elimine los archivos subidos de la carpeta de carga automáticamente.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura qué modelos usar para diferentes propósitos en eeroNotebook",
    missingRequiredModels: "Faltan modelos requeridos: {{models}}. eeroNotebook puede no funcionar correctamente sin estos.",
  ...
  apiKeys: {
    ...
    description: "Almacena claves API de forma segura en la base de datos para habilitar proveedores de IA en eeroNotebook.",
