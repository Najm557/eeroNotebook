...
export const bnIN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "eeroNotebook API সার্ভারে পৌঁছানো যায়নি",
    ...
    docLink: "Open Notebook ডকুমেন্টেশন",
  ...
  notebooks: {
    ...
    share: "শেয়ার",
    shareNotebook: "নোটবুক শেয়ার করুন",
    shareNotebookDesc: "একজনকে \"{{name}}\"-এ শুধু-পড়ার অ্যাক্সেস দিন। তিনি সোর্স পড়তে ও প্রশ্ন করতে পারবেন, কিছু পরিবর্তন করতে পারবেন না।",
    shareEmailLabel: "ইমেল ঠিকানা",
    shareEmailPlaceholder: "person@example.com",
    shareGrant: "অ্যাক্সেস দিন",
    shareOnePersonHint: "একবারে একজন। নোটবুক সবার সঙ্গে শেয়ার করার কোনো উপায় নেই।",
    shareLoading: "কাদের অ্যাক্সেস আছে তা লোড হচ্ছে...",
    shareNobodyYet: "এই নোটবুকে আর কারও অ্যাক্সেস নেই।",
    shareRoleViewer: "দর্শক",
    shareGrantedAgo: "অ্যাক্সেস দেওয়া হয়েছে {{time}}",
    shareUnnamedMember: "ইমেল ঠিকানা ছাড়া সদস্য",
    shareRevoke: "অ্যাক্সেস প্রত্যাহার করুন",
    shareRevokeConfirm: "এই নোটবুকে {{name}}-এর অ্যাক্সেস শেষ করবেন? অ্যাক্সেস সঙ্গে সঙ্গে বন্ধ হবে। নোটবুকের কোনো কিছুই মুছে যাবে না।",
    shareGrantSuccess: "অ্যাক্সেস দেওয়া হয়েছে",
    shareGrantFailed: "নোটবুক শেয়ার করা যায়নি",
    shareRevokeSuccess: "অ্যাক্সেস প্রত্যাহার করা হয়েছে",
    shareRevokeFailed: "অ্যাক্সেস প্রত্যাহার করা যায়নি",
    sharedWithYou: "আপনার সঙ্গে শেয়ার করা",
    viewerReadOnlyNotice: "এই নোটবুকে আপনার শুধু-পড়ার অ্যাক্সেস আছে। আপনি এর সোর্স পড়তে ও প্রশ্ন করতে পারেন।",
    noNotesViewer: "এই নোটবুকের মালিক এখনও কোনো নোট যোগ করেননি।",
  },
  sources: {
    bulkContext: "প্রসঙ্গ",
    ...
    noSourcesViewer: "এই নোটবুকের মালিক এখনও কোনো সোর্স যোগ করেননি।",
  ...
  settings: {
    ...
    filesHelp: "একবার আপনার ফাইল আপলোড এবং প্রক্রিয়া হওয়ার পর, সেগুলি আর প্রয়োজন নেই। বেশিরভাগ ব্যবহারকারী eeroNotebook কে আপলোড ফোল্ডার থেকে আপলোড করা ফাইল স্বয়ংক্রিয়ভাবে মুছে ফেলার অনুমতি দিতে পারেন।",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "eeroNotebook জুড়ে বিভিন্ন কাজের জন্য কোন মডেল ব্যবহার করব তা কনফিগার করুন",
    missingRequiredModels: "প্রয়োজনীয় মডেল অনুপস্থিত: {{models}}। এগুলি ছাড়া eeroNotebook সঠিকভাবে কাজ নাও করতে পারে।",
  ...
  apiKeys: {
    ...
    description: "eeroNotebook এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
