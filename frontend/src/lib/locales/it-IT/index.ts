...
export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di eeroNotebook non è raggiungibile",
  ...
  notebooks: {
    ...
    shareNotebookDesc: "Concedi a una persona l'accesso in sola lettura a \"{{name}}\". Potrà leggere le fonti e porre domande, ma non modificare nulla.",
    shareEmailLabel: "Indirizzo email",
    shareEmailPlaceholder: "persona@esempio.com",
    shareGrant: "Concedi accesso",
    shareOnePersonHint: "Una persona alla volta. Non è possibile condividere un taccuino con tutti.",
    shareLoading: "Caricamento di chi ha accesso...",
    shareNobodyYet: "Nessun altro ha accesso a questo taccuino.",
    shareRoleViewer: "Lettore",
    shareGrantedAgo: "Accesso concesso {{time}}",
    shareUnnamedMember: "Membro senza indirizzo email",
    shareRevoke: "Revoca accesso",
    shareRevokeConfirm: "Terminare l'accesso di {{name}} a questo taccuino? L'accesso cessa immediatamente. Nulla nel taccuino viene eliminato.",
    shareGrantSuccess: "Accesso concesso",
    shareGrantFailed: "Impossibile condividere il taccuino",
    shareRevokeSuccess: "Accesso revocato",
    shareRevokeFailed: "Impossibile revocare l'accesso",
    sharedWithYou: "Condiviso con te",
    viewerReadOnlyNotice: "Hai accesso in sola lettura a questo taccuino. Puoi leggerne le fonti e porre domande.",
    noNotesViewer: "Il proprietario di questo taccuino non ha ancora aggiunto note.",
  },
  sources: {
    ...
    noSourcesViewer: "Il proprietario di questo taccuino non ha ancora aggiunto fonti.",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a eeroNotebook di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in eeroNotebook",
    missingRequiredModels: "Modelli richiesti mancanti: {{models}}. eeroNotebook potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in eeroNotebook.",
